...
if (isset($_SESSION["supplier"]["role_id"])) {
    echo $_SESSION["supplier"]["role_id"] > 2 ? header('location:./?pages=bank-account/list') : '';
}
?>
...
<head>
    ...
    <title>Bank Account - <?php echo $main_title; ?></title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var jqForm = $('#bank-account-create-form'),
                picker = $('#dob'),
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/bank-account/function/create.php",
                            type: "POST",
                            ...
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=bank-account/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
