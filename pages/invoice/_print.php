...
?>
    ...
    <?php } elseif (count($inv_id) == 1) { ?>
        <div class="content-body" style="background-color: #fff;" id="invoice-preview-vertical">
            <div class="invoice-print <?php echo $action == "preview" && $type == 'POST' ? 'p-2' : 'p-0'; ?>">

                <div class="row align-items-center mb-3">
                    <div class="col-sm-6">
                        <!-- <img src="https://phuketsolution.com/demo/vuexy/img/logo-smile.webp" alt="qr code" width="400" class="img-fluid"> -->
                        <img src="app-assets/images/logo/logo-500.png" width="200">
                    </div>
                ...
                <h3 class="text-center text-uppercase mb-3">Invouce</h3>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Invoice To:</b> </td>
                                    <td><b><?php echo $agent_name[0]; ?></b></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap align-top"><b>Address:</b> </td>
                                    <td><b><?php echo $agent_address[0]; ?></b></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Tel:</b> </td>
                                    <td><b><?php echo $agent_telephone[0]; ?></b></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Email:</b> </td>
                                    <td><b><?php echo $agent_email[0]; ?></b></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Tax ID:</b> </td>
                                    <td><b><?php echo $agent_license[0]; ?></b></td>
                                </tr>
                    ...
                    <div class="col-sm-6">
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Invoice No:</b> </td>
                                    <td><b><?php echo $inv_full[0]; ?></b></td>
                                </tr>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap">Guest Name: </td>
                                    <td><?php echo $cus_name[0]; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap align-top">Booking No: </td>
                                    <td><?php echo $book_full[0]; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Voucher No:</td>
                                    <td><?php echo $voucher_no[0]; ?></td>
                                </tr>
                                <!-- <tr>
                            <td class="pr-2 text-nowrap">Service Code: </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td class="pr-2 text-nowrap">Service Date: </td>
                            <td>2024-11-29</td>
                        </tr> -->
                                <tr>
                                    <td class="pr-2 text-nowrap">Booking Date: </td>
                                    <td><?php echo date('j F Y', strtotime($created_at[0])); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap">Issue Date: </td>
                                    <td><?php echo date('j F Y', strtotime($inv_date[0])); ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Due Date: </td>
                                    <td><?php echo date('j F Y', strtotime($rec_date[0])); ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Prepared by: </td>
                                    <td><?php echo $user_name[0]; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Booker: </td>
                                    <td><?php echo $booker_name[0]; ?></td>
                                </tr>
                                <!-- <tr>
                            <td class="pr-2 text-nowrap">Sales(OP): </td>
                            <td>Am</td>
                        </tr> -->
                                <!-- <tr>
                            <td class="pr-2 text-nowrap">Sales(CS): </td>
                            <td></td>
                        </tr> -->
                            </tbody>
                        </table>
                ...
                <table class="table mb-2">
                    <thead>
                        <tr>
                            ...
                            <th class="py-1 text-center">Amont</th>
                        ...
                        <?php if (!empty($inv_id)) {
                            for ($i = 0; $i < count($inv_id); $i++) {
                                ...
                                for ($r = 0; $r < $rowspan; $r++) {
                                    $amount = $total[$bo_id[$i]][$r] + $amount;
                                    $sum_total = $total[$bo_id[$i]][$r] + $sum_total;
                                    $customer = $category_cus[$bo_id[$i]][$r] == 1 ? ' (Thai)' : ' (Foreign)'; //  Smile Rainbow One Day Trip Coral + Racha + Promthep - Adult 
                        ?>
                                    <tr>
                                        <td><?php echo $product_name[$i] . $customer . ' - Adult'; ?></td>
                                        <td class="text-center"><?php echo $adult[$bo_id[$i]][$r]; ?></td>
                                        <td class="text-center"><?php echo $rate_adult[$bo_id[$i]][$r] != '-' ? number_format($rate_adult[$bo_id[$i]][$r]) : $rate_adult[$bo_id[$i]][$r]; ?></td>
                                        <td class="text-center"><?php echo $rate_adult[$bo_id[$i]][$r] != '-' ? number_format($adult[$bo_id[$i]][$r] * $rate_adult[$bo_id[$i]][$r]) : $rate_adult[$bo_id[$i]][$r]; ?></td>
                                    </tr>
                                    <?php if ($child[$bo_id[$i]][$r] > 0) { ?>
                                        <tr>
                                            <td><?php echo $product_name[$i] . $customer . ' - Children'; ?></td>
                                            <td class="text-center"><?php echo $child[$bo_id[$i]][$r]; ?></td>
                                            <td class="text-center"><?php echo $rate_child[$bo_id[$i]][$r] != '-' ? number_format($rate_child[$bo_id[$i]][$r]) : $rate_child[$bo_id[$i]][$r]; ?></td>
                                            <td class="text-center"><?php echo $rate_child[$bo_id[$i]][$r] != '-' ? number_format($child[$bo_id[$i]][$r] * $rate_child[$bo_id[$i]][$r]) : $rate_child[$bo_id[$i]][$r]; ?></td>
                                        </tr>
                                    <?php }
                                    if ($infant[$bo_id[$i]][$r] > 0) { ?>
                                        <tr>
                                            <td><?php echo $product_name[$i] . $customer . ' - Infant'; ?></td>
                                            <td class="text-center"><?php echo $infant[$bo_id[$i]][$r]; ?></td>
                                            <td class="text-center"><?php echo $rate_infant[$bo_id[$i]][$r] != '-' ? number_format($rate_infant[$bo_id[$i]][$r]) : $rate_infant[$bo_id[$i]][$r]; ?></td>
                                            <td class="text-center"><?php echo $rate_infant[$bo_id[$i]][$r] != '-' ? number_format($infant[$bo_id[$i]][$r] * $rate_infant[$bo_id[$i]][$r]) : $rate_infant[$bo_id[$i]][$r]; ?></td>
                                        </tr>
                                    <?php }
                                    if ($foc[$bo_id[$i]][$r] > 0) { ?>
                                        <tr>
                                            <td><?php echo $product_name[$i] .  ' - FOC'; ?></td>
                                            <td class="text-center"><?php echo $foc[$bo_id[$i]][$r]; ?></td>
                                            <td class="text-center">-</td>
                                            <td class="text-center">-</td>
                                        </tr>
                                ...
                                <?php if (!empty($arr_extar[$bo_id[$i]]['id'])) {
                                    for ($e = 0; $e < count($arr_extar[$bo_id[$i]]['id']); $e++) {
                                        $amount = $arr_extar[$bo_id[$i]]['total'][$e] + $amount;
                                        $sum_total = $arr_extar[$bo_id[$i]]['total'][$e] + $sum_total;
                                        if ($arr_extar[$bo_id[$i]]['type'][$e] == 2) {  ?>
                                            <tr>
                                                <td><?php echo $arr_extar[$bo_id[$i]]['name'][$e]; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['privates'][$e]; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_private'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['rate_private'][$e]) : $arr_extar[$bo_id[$i]]['rate_private'][$e]; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_private'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['privates'][$e] * $arr_extar[$bo_id[$i]]['rate_private'][$e]) : $arr_extar[$bo_id[$i]]['rate_private'][$e]; ?></td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                                <td><?php echo $arr_extar[$bo_id[$i]]['name'][$e] . ' - Adult'; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['adult'][$e]; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_adult'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['rate_adult'][$e]) : $arr_extar[$bo_id[$i]]['rate_adult'][$e]; ?></td>
                                                <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_adult'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['adult'][$e] * $arr_extar[$bo_id[$i]]['rate_adult'][$e]) : $arr_extar[$bo_id[$i]]['rate_adult'][$e]; ?></td>
                                            </tr>
                                            <?php if ($arr_extar[$bo_id[$i]]['child'][$e]) { ?>
                                                <tr>
                                                    <td><?php echo $arr_extar[$bo_id[$i]]['name'][$e] . ' - Children'; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['child'][$e]; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_child'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['rate_child'][$e]) : $arr_extar[$bo_id[$i]]['rate_child'][$e]; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_child'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['child'][$e] * $arr_extar[$bo_id[$i]]['rate_child'][$e]) : $arr_extar[$bo_id[$i]]['rate_child'][$e]; ?></td>
                                                </tr>
                                            <?php }
                                            if ($arr_extar[$bo_id[$i]]['infant'][$e]) { ?>
                                                <tr>
                                                    <td><?php echo $arr_extar[$bo_id[$i]]['name'][$e] . ' - Infant'; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['infant'][$e]; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_infant'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['rate_infant'][$e]) : $arr_extar[$bo_id[$i]]['rate_infant'][$e]; ?></td>
                                                    <td class="text-center"><?php echo $arr_extar[$bo_id[$i]]['rate_infant'][$e] != '-' ? number_format($arr_extar[$bo_id[$i]]['infant'][$e] * $arr_extar[$bo_id[$i]]['rate_infant'][$e]) : $arr_extar[$bo_id[$i]]['rate_infant'][$e]; ?></td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
                                <?php
                ...
                <div class="row justify-content-end">
                    ...
                    <div class="col-6">
                        ...
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap">Pickup:</td>
                                    <td><?php echo ($pickup_type[0] == 1) ? !empty($zone_pickup[0]) ? $hotel_pickup[0] . '/' . $zone_pickup[0] : $hotel_pickup[0] : 'เดินทางมาเอง'; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Dropoff:</td>
                                    <td><?php echo ($pickup_type[0] == 1) ? !empty($zone_dropoff[0]) ? $hotel_dropoff[0] . '/' . $zone_dropoff[0] : $hotel_dropoff[0] : 'เดินทางมาเอง'; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Time:</td>
                                    <td>
                                        <?php echo $start_pickup[0] . ' - ' . $end_pickup[0]; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Room No:</td>
                                    <td>
                                        <?php echo $room_no[0]; ?>
                                    </td>
                                </tr>
                    ...
                    <div class="col-6">
                        <table class="mb-3 text-right w-100">
                            <tbody>
                                <!-- <tr>
                            <td class="pr-2 text-nowrap">Difference</td>
                            <td><b>0.00</b></td>
                        </tr> -->
                                <tr>
                                    <td class="pr-2 text-nowrap">Subtotal</td>
                                    <td><b><?php echo number_format($sum_total, 2); ?></b></td>
                                </tr>
                                <?php if (!empty($discount)) { ?>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Discount</td>
                                        <td><b><?php echo number_format(array_sum($discount), 2); ?></b></td>
                                    </tr>
                                <?php } ?>
                                <?php if (!empty($cot)) { ?>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Cash on tour</td>
                                        <td><b><?php echo number_format(array_sum($cot), 2); ?></b></td>
                                    </tr>
                                <?php } ?>
                                <?php if ($vat[0] > 0) { ?>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Tax</td>
                                        <td><b><?php echo number_format($vat_total, 2); ?></b></td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Tax Rate</td>
                                        <td><b><?php echo $vat[0]; ?>.00%</b></td>
                                    </tr>
                                <?php } ?>
                                <?php if ($withholding[0] > 0) { ?>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Withholding Tax</td>
                                        <td><b><?php echo number_format($withholding_total, 2); ?></b></td>
                                    </tr>
                                    <tr>
                                        <td class="pr-2 text-nowrap">Withholding Tax Rate</td>
                                        <td><b><?php echo $withholding[0]; ?>.00%</b></td>
                                    </tr>
                                <?php } ?>
                                <tr>
                                    <td class="pr-2 text-nowrap">Total</td>
                ...
                <div class="row justify-content-end">
                    <div class="col-6">
                        ...
                        <p class="text-danger"><b>Please Transfer this Bank Account</b></p>
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap">Name of Beneficiary:</td>
                                    <td><?php echo $account_name[0]; ?></td>
                                </tr>
                                <!-- <tr>
                            <td class="pr-2 text-nowrap">Address of Beneficiary:</td>
                            <td>3/4 Moo 8 Chalong, Muang, Phuket 83130</td>
                        </tr> -->
                                <tr>
                                    <td class="pr-2 text-nowrap">Account Number:</td>
                                    <td><?php echo $account_no[0]; ?></td>
                                </tr>
                                <tr>
                                    <td class="pr-2 text-nowrap">Beneficiary's Bank:</td>
                                    <td>
                                        <div class="badge badge-light-warning"><?php echo $bank_name[0]; ?></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-6">
                        <table class="mb-3">
                            <tbody>
                                <tr>
                                    <td class="pr-2 text-nowrap"><b>Remark:</b></td>
                                    <td><?php echo $inv_note[0]; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
