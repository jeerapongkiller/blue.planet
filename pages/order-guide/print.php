...
if (isset($_GET['action']) && $_GET['action'] == "print") {
    ...
    # --- get data --- #
    $orders = $orderObj->showlistboats('guide', 0, $date_travel, $search_boat, $search_guide, $search_status, $search_agent, $search_product, $search_voucher_no, $refcode, $name, '');
    # --- Check products --- #
    if (!empty($orders)) {
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr class="<?php echo $class_tr; ?>">
                                        ...
                                        <td style="padding: 5px;"><?php echo (!empty($managet['car'][$id][1])) ? $managet['car'][$id][1] : '';
                                        ...
                                        <td class="text-nowrap"><?php echo $language[$id]; ?></td>
