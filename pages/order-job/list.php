            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    ...
                    <div class="content-header">
                        ...
                        <form id="order-job-search-form" name="order-job-search-form" method="GET" enctype="multipart/form-data">
                    ...
                    <div id="order-jobs-search-table">
                        ...
                        $sum_inf = 0;
                        # --- get data --- #
                        $orders = $orderObj->showlistboats('job', 0, $get_date, $search_boat, 'all', $search_status, $search_agent, $search_product, $search_voucher_no, $refcode, $name, '');
                        if (!empty($orders)) {
                                        ...
                                        <table class="table table-striped text-uppercase table-vouchure-t2">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th colspan="5" style="background-color: <?php echo $color_hex[$i]; ?>; <?php echo $text_color[$i] != '' ? 'color: ' . $text_color[$i] . ';' : ''; ?>">
