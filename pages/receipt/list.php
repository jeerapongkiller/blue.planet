                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 col-12">
                                        <span id="span-img">
                                            ...
                                            <input type="hidden" id="before_file" name="before_file" class="form-control" value="" />
                                            <div class="d-flex align-items-center justify-content-center mt-2 mb-2">
                                                <img id="img-file" src="" class="img-fluid product-img" alt="image" width="250" />
                                            </div>
                                        </span>
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <!-- <input type="hidden" id="before_file" name="before_file" value=""> -->
                                        </div>
                                    </div>
                                </div>
